...
//    public void init(HashMap<LocalDate,ArrayList<Bookings>> eventhashmap, LocalDate mindate, LocalDate maxdate){
//        eventusers=eventhashmap;
//        viewPager=findViewById(R.id.viewpager);
//        viewPager.setOffscreenPageLimit(2);
//        this.mindate=mindate;
//        this.maxdate=maxdate;
...
//
//        final ArrayList<MonthModel> arrayList=new ArrayList<>();
//        HashMap<LocalDate,ArrayList<Bookings>> eventhash=new HashMap<>();
//
//        for (int i=0;i<=months;i++){
//
//            int firstday =mindateobj.dayOfMonth().withMinimumValue().dayOfWeek().get();
...
//                dayModel.setMonth(startday.getMonthOfYear());
//                dayModel.setYear(startday.getYear());
//                if (eventusers.containsKey(startday.toLocalDate())){
//                    if (eventhash.containsKey(startday.toLocalDate())){
//                        List<ArrayList<Bookings>> list=Arrays.asList(eventhash.get(startday.toLocalDate()));
//                        list=new ArrayList<>(list);
//                        for(String s:eventusers.get(startday.toLocalDate())){
//                            list.add(s);
//                        }
//                        String[] mStringArray = new String[list.size()];
//                        String[] s=list.toArray(mStringArray);
...
//
//                    }
//                    else eventhash.put(startday.toLocalDate(),eventusers.get(startday.toLocalDate()));
//                    dayModel.setEventlist(true);
//
//                } // check if require jitu
//
//                if (startday.toLocalDate().equals(new LocalDate())){
//                    dayModel.setToday(true);
//                    currentmonth=i;
...
//    }
    ...
    public void init(HashMap<LocalDate,String[]> eventhashmap,LocalDate mindate,LocalDate maxdate, HashMap<LocalDate, ArrayList<Bookings>> localDateHashMap) {
        eventuser=eventhashmap;
        viewPager=findViewById(R.id.viewpager);
        viewPager.setOffscreenPageLimit(2);
        this.mindate=mindate;
